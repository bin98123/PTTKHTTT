	...
	<div class="container" style="margin-top: 10px;">
		<div class="row"
			...
			<div class="col-sm-12">
				...
				<h2 class="myclass" style="color: blue;">Đổi Tên Trạm Dừng</h2>
				<form action="EditBusStop" method="post">
					<!-- 					<div class="form-group"> -->
					<!-- 						<label>Mã số chuyến</label> -->
					...
					<%-- 							<% --%>
					<!-- 					// List -->
					<!-- 					<BusRouteDetails> busList = new ArrayList<BusRouteDetails>(); -->
					<!-- 					// Chuyen c = new Chuyen(); // busList = c.getRouteName(); // for -->
					<%-- 					(BusRouteDetails bus : busList) { 							%> 							<option value="<%=bus.getRouteName()%>"><%=bus.getRouteName()%></option> --%>
					<%-- 							<% --%>
					<!-- 					// } -->
					<%-- 							%> --%>
					<!-- 						</select> -->
					...
					<div class="form-group">
						<label>Tên Trạm</label> <input type="text" class="form-control"
							name="nameBusStopInput" placeholder="Nhập Tên Trạm">
					</div>
