...
/**
 * Servlet implementation class ManagerSearchDriverServlet
 */
@WebServlet("/ManagerSearchDriver")
public class ManagerSearchDriverServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ManagerSearchDriverServlet() {
		super();
...
//			throws ServletException, IOException {
		...
		try {
			...
			request.setAttribute("listManaDriver", searchDAO.getSearchDriver(txtSearch));
