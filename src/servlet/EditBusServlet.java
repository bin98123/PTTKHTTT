...
public class EditBusServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// busID
		String idBus = (String) session.getAttribute("idBus");
...
//		String busID = request.getParameter("busID");
		...
		BusDetails unitDetails = new BusDetails(idBus, license, kind, manuDay, guaDay, routeID);
		BusDAO dao = new BusDAO();
		try {
//			dao.add(driverDetails);
			dao.edit(unitDetails, idBus);
